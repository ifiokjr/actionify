export {
  objectEntries,
  objectKeys,
} from "https://cdn.skypack.dev/ts-extras@0.11.0?dts";
export { parse } from "https://deno.land/std@0.155.0/flags/mod.ts";
export * from "https://deno.land/std@0.155.0/fs/mod.ts";
export * from "https://deno.land/std@0.155.0/fs/mod.ts";
export { readLines } from "https://deno.land/std@0.155.0/io/mod.ts";
export { getLogger } from "https://deno.land/std@0.155.0/log/mod.ts";
